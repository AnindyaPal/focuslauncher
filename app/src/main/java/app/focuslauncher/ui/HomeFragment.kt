...
import app.focuslauncher.MainViewModel
import app.focuslauncher.R
import app.focuslauncher.data.AppModel
import app.focuslauncher.data.Constants
import app.focuslauncher.data.Prefs
import app.focuslauncher.databinding.FragmentHomeBinding
import app.focuslauncher.helper.expandNotificationDrawer
import app.focuslauncher.helper.getChangedAppTheme
import app.focuslauncher.helper.getUserHandleFromString
import app.focuslauncher.helper.isPackageInstalled
import app.focuslauncher.helper.openAlarmApp
import app.focuslauncher.helper.openCalendar
import app.focuslauncher.helper.openCameraApp
import app.focuslauncher.helper.openDialerApp
import app.focuslauncher.helper.openSearch
import app.focuslauncher.helper.setPlainWallpaperByTheme
import app.focuslauncher.helper.showToast
import app.focuslauncher.listener.OnSwipeTouchListener
import app.focuslauncher.listener.ViewSwipeTouchListener
